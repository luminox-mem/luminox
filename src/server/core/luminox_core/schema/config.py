...
class CoreConfig(BaseModel):
    ...
    # MQ Configuration
    mq_url: str = "amqp://luminox:helloworld@127.0.0.1:15672/"
    mq_connection_name: str = "luminox_core"
    mq_heartbeat: int = (
    ...
    database_url: str = "postgresql://luminox:helloworld@127.0.0.1:15432/luminox"
    ...
    s3_access_key: str = "luminox"  # Default MinIO root user
    s3_secret_key: str = "helloworld"  # Default MinIO root password
    s3_bucket: str = "luminox-assets"  # Default bucket name
    ...
    otel_service_name: str = "luminox-core"
