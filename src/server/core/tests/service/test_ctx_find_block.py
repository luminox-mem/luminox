import pytest
from luminox_core.schema.orm import Project, Space
from luminox_core.schema.orm.block import BLOCK_TYPE_FOLDER, BLOCK_TYPE_PAGE
from luminox_core.infra.db import DatabaseClient
from luminox_core.service.data.block import create_new_path_block
from luminox_core.llm.tool.space_lib.ctx import SpaceCtx
