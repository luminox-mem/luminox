import pytest
from luminox_core.schema.orm import Block, BlockEmbedding, Project, Space
from luminox_core.schema.orm.block import BLOCK_TYPE_PAGE, BLOCK_TYPE_FOLDER
from luminox_core.infra.db import DatabaseClient
from luminox_core.service.data.block_search import search_path_blocks
