...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("database.dsn", "host=127.0.0.1 user=luminox password=helloworld dbname=luminox port=15432 sslmode=disable TimeZone=UTC")
	...
	v.SetDefault("s3.accessKey", "luminox")
	v.SetDefault("s3.secretKey", "helloworld")
	v.SetDefault("s3.bucket", "luminox-assets")
	v.SetDefault("rabbitmq.url", "amqp://luminox:helloworld@127.0.0.1:15672/%2F")
