...
//	@Param			user	formData	string	false	"User identifier to associate with the skill"	example(alice@luminox.io)
...
//	@Accept			json
//	@Produce		json
//	@Param			user		query	string	false	"User identifier to filter skills"	example(alice@luminox.io)
