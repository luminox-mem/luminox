	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func(svc *MockUserService) {
				svc.On("Delete", mock.Anything, projectID, "alice@luminox.io").Return(nil)
			},
		...
		},
		{
			...
			identifier: "alice@luminox.io",
			setup: func(svc *MockUserService) {
				svc.On("Delete", mock.Anything, projectID, "alice@luminox.io").Return(errors.New("database error"))
			},
	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func(svc *MockUserService) {
				...
				svc.On("GetResourceCounts", mock.Anything, projectID, "alice@luminox.io").Return(expectedOutput, nil)
			},
			expectedStatus: http.StatusOK,
		},
		{
			...
			setup: func(svc *MockUserService) {
				...
				svc.On("GetResourceCounts", mock.Anything, projectID, "newuser@luminox.io").Return(expectedOutput, nil)
			},
			expectedStatus: http.StatusOK,
		},
		{
		...
		},
		{
			...
			identifier: "alice@luminox.io",
			setup: func(svc *MockUserService) {
				svc.On("GetResourceCounts", mock.Anything, projectID, "alice@luminox.io").Return(nil, errors.New("database error"))
			},
			expectedStatus: http.StatusInternalServerError,
		},
	}
