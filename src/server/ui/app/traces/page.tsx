...
function TraceRow({
  ...
  const getSpanColorClass = (processID: string) => {
    ...
    const serviceColorClasses: Record<string, string> = {
      "luminox-api": "bg-teal-400 dark:bg-teal-400", // lighter teal - gentle and calm
      "luminox-core": "bg-blue-400 dark:bg-blue-400", // lighter blue - friendly and inviting
    };
  ...
  const getSpanIndicatorColorClass = (processID: string) => {
    ...
    const indicatorColorClasses: Record<string, string> = {
      "luminox-api": "bg-teal-400 dark:bg-teal-400",
      "luminox-core": "bg-blue-400 dark:bg-blue-400",
    };
