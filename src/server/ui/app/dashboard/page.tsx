    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500/20 to-fuchsia-500/20 border border-cyan-500/30">
            <svg className="w-6 h-6 text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
          </div>
          <div>
            <h1 className="font-display text-3xl font-bold tracking-wide text-glow-cyan">{t("title")}</h1>
            <p className="font-tech text-sm text-muted-foreground">Real-time analytics & insights</p>
          </div>
        </div>
        <div className="flex items-center gap-3 px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500/5 to-fuchsia-500/5 border border-cyan-500/20">
          <span className="text-sm font-tech text-muted-foreground">{t("timeRange")}:</span>
          <Select value={timeRange} onValueChange={(value) => setTimeRange(value as TimeRange)}>
            <SelectTrigger className="w-[140px] border-cyan-500/30 bg-background/50 backdrop-blur-sm font-tech">
              <SelectValue />
            </SelectTrigger>
            <SelectContent className="font-tech">
          ...
          {isLoading && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-tech text-cyan-400">Syncing...</span>
            </div>
          )}
        </div>
      </div>
