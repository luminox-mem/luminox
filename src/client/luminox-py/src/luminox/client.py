"""
High-level synchronous client for the Luminox API.
"""
...
class LuminoxClient:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            timeout: Request timeout in seconds. Defaults to 32.0. Can also be set via LUMINOX_TIMEOUT env var.
    ...
    def __enter__(self) -> "LuminoxClient":
        return self
