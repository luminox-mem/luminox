...
from ..client import LuminoxClient
...
class WriteFileTool(BaseTool):
    """Tool for writing text content to a file on the Luminox disk."""
...
class ReadFileTool(BaseTool):
    """Tool for reading a text file from the Luminox disk."""
...
class ReplaceStringTool(BaseTool):
    """Tool for replacing an old string with a new string in a file on the Luminox disk."""
...
class ListTool(BaseTool):
    """Tool for listing files in a directory on the Luminox disk."""
...
class DownloadFileTool(BaseTool):
    """Tool for getting a public download URL for a file on the Luminox disk."""
...
class DiskToolPool(BaseToolPool):
    """Tool pool for disk operations on Luminox disks."""

    def format_context(self, client: LuminoxClient, disk_id: str) -> DiskContext:
        return DiskContext(client=client, disk_id=disk_id)

    async def async_format_context(
        self, client: LuminoxAsyncClient, disk_id: str
    ) -> AsyncDiskContext:
