...
class SkillContext(BaseContext):
    ...
    @classmethod
    def create(cls, client: LuminoxClient, skill_ids: list[str]) -> "SkillContext":
        """Create a SkillContext by preloading skills from a list of skill IDs.

        Args:
            client: The Luminox client instance.
...
class AsyncSkillContext(BaseContext):
    ...
    @classmethod
    async def create(
        cls, client: LuminoxAsyncClient, skill_ids: list[str]
    ) -> "AsyncSkillContext":
        """Create an AsyncSkillContext by preloading skills from a list of skill IDs.

        Args:
            client: The Luminox async client instance.
            skill_ids: List of skill UUIDs to preload.
...
class SkillToolPool(BaseToolPool):
    """Tool pool for skill operations on Luminox skills."""

    def format_context(
        self, client: LuminoxClient, skill_ids: list[str]
    ) -> SkillContext:
        """Create a SkillContext by preloading skills from a list of skill IDs.
    ...
    async def async_format_context(
        self, client: LuminoxAsyncClient, skill_ids: list[str]
    ) -> AsyncSkillContext:
        """Create an AsyncSkillContext by preloading skills from a list of skill IDs.
