...
@dataclass(slots=True)
class LuminoxMessage:
    """
    Represents an Luminox-format message payload.
    """
...
def build_luminox_message(
    *,
    ...
    """
    Construct an Luminox-format message blob and associated multipart files.
    """
