...
import (
	...
	"github.com/memodb-io/Luminox/luminox-cli/cmd"
	"github.com/memodb-io/Luminox/luminox-cli/internal/logo"
	"github.com/memodb-io/Luminox/luminox-cli/internal/telemetry"
	"github.com/memodb-io/Luminox/luminox-cli/internal/version"
...
func main() {
	...
	if len(os.Args) == 1 {
		...
		// Skip logo for "--" followed by "help" (e.g., "luminox -- help")
...
func buildCommandPath(cmd *cobra.Command) string {
	...
	current := cmd
	for current != nil && current.Use != "luminox" {
...
var rootCmd = &cobra.Command{
	Use:   "luminox",
	Short: "Luminox CLI - Build context-aware AI applications",
	Long: `Luminox CLI is a command-line tool for quickly creating Luminox projects.
...
Get started by running: luminox create
`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println(logo.Logo)
		fmt.Println()
		fmt.Println("Welcome to Luminox CLI!")
		fmt.Println()
		fmt.Println("Quick Commands:")
		fmt.Println("  luminox create     Create a new project")
		fmt.Println("  luminox docker     Manage Docker services (up/down/status/logs/env)")
		fmt.Println("  luminox version    Show version information")
		fmt.Println("  luminox upgrade    Upgrade to the latest version")
		fmt.Println("  luminox help       Show help information")
		fmt.Println()
		fmt.Println("Get started: luminox create")
	},
}
...
var versionCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Printf("Luminox CLI version %s\n", cliVersion)
...
func checkUpdateAsync() {
	go func() {
		...
		if hasUpdate {
			...
			fmt.Println("   Run 'luminox upgrade' to update")
			fmt.Println()
		}
	}()
}
