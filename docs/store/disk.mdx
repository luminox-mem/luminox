---
title: Artifacts
description: "Luminox offers a filesystem-like disk for storing artifacts."
---

The Disk API provides persistent, S3-backed storage for file artifacts in your Luminox projects. 
...
```typescript TypeScript
import { FileUpload } from 'luminox-sdk';
...
```typescript TypeScript
import { LuminoxClient, FileUpload } from 'luminox-sdk';
...
```python
import asyncio
from luminox import AsyncLuminoxClient, FileUpload
