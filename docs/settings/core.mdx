---
title: "Dependencies"
description: "Core settings are used to configure important deps and services."
---

## Basic Environment Variables

Configure your luminox core services using these essential environment variables. All environment variables use uppercase field names corresponding to the configuration schema.
