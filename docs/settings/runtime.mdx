---
title: Runtime
description: Runtime settings are used to configure the runtime behavior of the Luminox Agent.
---


### Session Message Buffer
Luminox will track the agent task and user feedback in the session, 
...
<ParamField path="DEFAULT_SOP_AGENT_MAX_ITERATIONS" type="integer" default="4">
Maximum number of iterations for Standard Operating Procedure (SOP) agents. Controls how many steps an SOP agent can take.
</ParamField>

<ParamField path="DEFAULT_SPACE_CONSTRUCT_AGENT_MAX_ITERATIONS" type="integer" default="16">
...
DEFAULT_SOP_AGENT_MAX_ITERATIONS=6
DEFAULT_SPACE_CONSTRUCT_AGENT_MAX_ITERATIONS=24
```
...
DEFAULT_SOP_AGENT_MAX_ITERATIONS=3
DEFAULT_SPACE_CONSTRUCT_AGENT_MAX_ITERATIONS=12
```
</CodeGroup>
