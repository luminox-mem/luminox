...
description: "Luminox can wait for user confirmation before actually learning skills"
---

By default, Luminox will automatically learn skills from completed tasks. 
...
Once you enable it, for every worth-learning experience, Luminox will wait for user confirmation before actually learning skills.
