...
description: "Luminox allows you to add rules to judge what is a complex task."
---

Luminox won't just learn every success/failed tasks into the skill space. It only learns the complex tasks.
