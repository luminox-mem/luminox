...
description: "Luminox offers few context editing methods for your agent context management."
---
...
Luminox supports to edit the session context when you obtain the current messages.
...
<Info>
The token count of Luminox is relative and proportional to the length of your session. 
