---
title: Quickstart
description: "Install Luminox SDK and run a demo script"
---

Get up and running with Luminox in under 5 minutes. This guide walks you through setting up the server, installing the SDK, and storing your first messages.

<Steps>
<Step title="Start Luminox server">

Choose between hosted or self-hosted Luminox:

<Tabs>
<Tab title="Hosted (Recommended)">
Go to [Luminox Dashboard](https://dash.luminox.io) and sign up for a free account. The onboarding process will guide you to get an API key.

Set your API key as an environment variable:

```bash
export LUMINOX_API_KEY="your-api-key"
```
</Tab>

<Tab title="Self-hosted">
Refer to [local deployment](/settings/local) to start Luminox server in 2 commands. This launches:
...
<Check>
If you see the success message and your stored messages, you're ready to start using Luminox!
</Check>
...
- Verify your Luminox server is running
...
- Confirm the package is installed: `pip list | grep luminox` (Python) or `npm list luminox` (TypeScript)
...
Store and manage files and artifacts in Luminox
</Card>
